...
**[2024/6/7]** The prompts used for generating videos, the attribute partitioning involved in prompts, and the partitioning of the dataset validation set, test set, and training set have been open-source. Unfortunately, we are unable to directly provide real videos. You can download them from the original dataset based on the video_id of prompts.  
## Abstract
